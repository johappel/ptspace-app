...
2. `ROADMAP.md`
3. `REFACTOR-UX.md`
4. `docs/design/DENKRAUM-DESIGN-CONTRACT.md`
5. `docs/milestones/REAL-RUNTIME-MVP.md`
6. das GitHub-Issue, das den aktuellen Auftrag beschreibt
7. die dort ausdrücklich genannten Quell- und Vertragsdateien

Bei Widersprüchen gilt für den aktuellen Meilenstein diese Reihenfolge:

1. aktueller Kernel `pedagogical-thinking-space`
2. `REFACTOR-UX.md` und `docs/design/DENKRAUM-DESIGN-CONTRACT.md` für das Nutzungserlebnis
3. `docs/milestones/REAL-RUNTIME-MVP.md`
4. aktuelles GitHub-Issue
5. `ROADMAP.md`
6. ältere App-Dokumente

## Aktueller Produktfokus

Die App wird vom Mock-/Hybridprototyp zu einem reproduzierbaren, harness-basierten MVP weiterentwickelt, ohne ihren Charakter als ruhiger, hochwertiger pädagogischer Denkraum zu verlieren.

Die Reihenfolge ist verbindlich:

0. Denkraum-Design-Gate und visuelle Referenzzustände absichern
...
5. Browser-E2E, visuelle Regression und CI-Gates ergänzen
6. Tastatur-, Screenreader-, Responsive- und qualitative Designabnahme durchführen
...
- Der Planungsraum ist ein **Denkraum, niemals ein Dashboard**.
- Das Gespräch und der gemeinsame pädagogische Gegenstand bilden die visuelle und funktionale Mitte.
- Gleichgewichtige Kartenraster, konkurrierende Statuspanels und technische Cockpit-Logik sind Ausschlusskriterien.
- Jeder Frontend-PR weist nach, wie er `REFACTOR-UX.md` und den `DENKRAUM-DESIGN-CONTRACT` erfüllt.
- Frontend-Änderungen dokumentieren mindestens einen relevanten Referenzzustand per Screenshot oder visueller Regression.
...
- Ein Arbeitspaket ist erst abgeschlossen, wenn die im Meilenstein definierten Tests, Design-Gates und Abnahmekriterien erfüllt sind.

## Arbeitsweise pro Issue

1. Auftrag und Abgrenzung lesen.
2. Betroffene Verträge, Dateien, Designzustände und Tests ermitteln.
...
5. Unit-, Integrations-, E2E- und gegebenenfalls visuelle Regressionstests ergänzen.
...
## Designprüfung pro Frontend-PR

Der Handoff beantwortet:

- Bleibt das Gespräch der visuelle Mittelpunkt?
- Ist der aktuelle pädagogische Fokus sofort erkennbar?
- Welche Dashboard-Muster wurden ausdrücklich vermieden?
- Wie bleibt die Herkunft neuer Zustände aus dem Gespräch nachvollziehbar?
- Wie fügt sich die Änderung in Typografie, Abstände, Materialität und Raumsemantik ein?
- Funktioniert der Ablauf ohne Illustration, Ton und Animation sowie mit Tastatur?

## Statuspflege

- `ROADMAP.md` zeigt den knappen Gesamtstand.
- `REFACTOR-UX.md` beschreibt das vollständige UX-Zielbild.
- `docs/design/DENKRAUM-DESIGN-CONTRACT.md` definiert prüfbare Design-Gates.
...
- Nur belegte, getestete und gestalterisch abgenommene Ergebnisse werden als abgeschlossen markiert.
